          ...
          <div>
            <div className="mx-auto max-w-6xl px-6 lg:px-8">
              <div className="mt-16 flow-root sm:mt-24">
                <div className="-m-2 rounded-xl bg-gray-900/5 dark:bg-gray-800/50 p-2 ring-1 ring-inset ring-gray-900/10 dark:ring-gray-600/10 lg:-m-4 lg:rounded-2xl lg:p-4">
                  <img
                    src=""
                    alt="product preview"
                    width={1364}
                    height={866}
                    className="rounded-md bg-white dark:bg-gray-900 p-2 sm:p-8 md:p-20 shadow-2xl ring-1 ring-gray-900/10 dark:ring-gray-600/10"
                  />
                </div>
              </div>
            </div>
        ...
        <div className="mb-12 px-6 lg:px-8">
          <div className="mx-auto max-w-2xl sm:text-center">
            ...
            <p className="mt-4 text-lg text-gray-600 dark:text-gray-400">
              Chatting to your PDF files has never been easier than with PagePal
            </p>
          </div>
        </div>
